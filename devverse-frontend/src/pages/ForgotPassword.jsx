    ...
    <AuthLayout>
      <div className="w-full max-w-md mx-auto space-y-6">
        ...
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-indigo-100 dark:bg-[#1e1b4b] shadow-sm shadow-indigo-100/50 dark:shadow-none">
          {step === 1 && <Key className="h-6 w-6 text-indigo-600 dark:text-[#c084fc]" />}
          {step === 2 && <MailOpen className="h-6 w-6 text-indigo-600 dark:text-[#c084fc]" />}
          {step === 3 && <ShieldCheck className="h-6 w-6 text-indigo-600 dark:text-[#c084fc]" />}
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-[15px] leading-relaxed">
            {step === 1 && "No worries. Enter your email and we'll send you a reset link in seconds."}
            {step === 2 && (
              <>
                We sent a verification code to <span className="font-semibold text-slate-700 dark:text-slate-300">{email}</span>. Please enter it below.
              </>
            )}
            {step === 3 && "Your new password must be different from your previous passwords."}
          </p>
        </div>
