  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-4">
        <Button
          variant="outline"
          className="h-11 shadow-sm border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 font-medium hover:bg-slate-50 dark:hover:bg-slate-800 dark:bg-transparent"
          asChild
        >
          <NavLink
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-[11px] uppercase font-semibold tracking-wider">
          <span className="bg-white dark:bg-background px-3 text-slate-400 dark:text-slate-500">
            or continue with
          </span>
        </div>
      </div>
